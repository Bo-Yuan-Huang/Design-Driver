  ...
  assign buff[138] = 8'ha5;
  assign buff[139] = 8'h0;
  assign buff[140] = 8'h0;
  assign buff[141] = 8'he8;
  assign buff[142] = 8'h94;
  assign buff[143] = 8'h5;
  assign buff[144] = 8'h60;
  assign buff[145] = 8'h4;
  assign buff[146] = 8'h80;
  assign buff[147] = 8'hf6;
  assign buff[148] = 8'h8;
  assign buff[149] = 8'h32;
  assign buff[150] = 8'h2;
  assign buff[151] = 8'h0;
  assign buff[152] = 8'h62;
  assign buff[153] = 8'h75;
  assign buff[154] = 8'h82;
  assign buff[155] = 8'h0;
  assign buff[156] = 8'h22;
  wire [15:0] addr0 = addr;
  wire [15:0] addr1 = addr+1;
  wire [15:0] addr2 = addr+2;
  wire [15:0] addr3 = addr+3;
  wire [7:0] data_o0 = (addr0 < 157) ? buff[addr0] : 8'h0;
  wire [7:0] data_o1 = (addr1 < 157) ? buff[addr1] : 8'h0;
  wire [7:0] data_o2 = (addr2 < 157) ? buff[addr2] : 8'h0;
  wire [7:0] data_o3 = (addr3 < 157) ? buff[addr3] : 8'h0;

...
wire arbiter_state_idle_next  = 
        ((stb_A || stb_B || stb_C || stb_D) && !ack) ? STATE_INUSE : STATE_IDLE;
...
wire [1:0] arbit_winner = (!stb_A && !stb_B && !stb_C && stb_D) ? PORT_D :

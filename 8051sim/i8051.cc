...
I8051::Simulate(const char* inFile, const char* outFile) 
{
    ...
    if( !LoadHex(inFile) ) {
        return false;
            ...
            os.open(outFile);
            if( os.bad() ) {
                std::cerr << "Error: bad output file." << std::endl;
                return false;
            }
        #endif
        ...
        std::cout << std::left;
        std::cout << std::endl;
        std::cout << std::setw(45) << "Instructions Executed: " 
             << instrCount << std::endl;
        std::cout << std::setw(45) << "Execution Time(seconds): " 
             << time << std::endl;
        std::cout << std::setw(45) << "Average Instructions/second: " 
             << instrCount/time << std::endl;
        std::cout << std::endl;
        std::cout << std::setw(45) << "Clock Cycles Required for 8051: " 
             << cycleCount << std::endl;
        std::cout << std::setw(45) << "Execution Time for 8051(12 MHz)(seconds): " 
             << cycleCount/12e6 << std::endl;
        std::cout << std::setw(45) << "Average Instructions/second for 8051: " 
             << instrCount/(cycleCount/12e6) << std::endl;
        std::cout << std::endl;
        return true;
    }
}    
